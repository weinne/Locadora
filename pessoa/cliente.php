...
<body>
	<ul class="menu">
		<li class="current"><a href="">Pessoa</a>
			<ul>
				<li class="current"><a href="<?php echo $UrlSite ?>pessoa/cliente.php"></span>Cliente</a></li>
	...
	<ul class="tabs left">
		...
		<li><a href="#alt" onClick="pegaListaAltera('cliente')">Alterar</a></li>
	</ul>
	...
	<div class="tab-content" id="cad">
		<form name="FormCliente" id="FormCliente">
			...
			<label>
				<span>Pontos:</span> 
				<input type="text" name="Pontos" id="Pontos" class="input-num" placeholder="Pontos" />
			</label><br/>
			<label>
				<span>.</span> 
				<input type="button" name="Enviar" id="Enviar" value="Salvar" onClick="cadastra('cliente', 'FormCliente');" />
			</label><br/>
		</form>
	</div>
